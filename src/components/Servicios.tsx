...
const Servicios = () => {
  ...
  return (
    <section
      id="servicios"
      className="py-12 md:py-16 sm:py-24 md:py-32 bg-gradient-to-b from-foreground via-foreground to-foreground/95 dark:from-card dark:via-card dark:to-card transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] relative overflow-hidden"
    >
      {/* Decorative elements - Hidden on mobile */}
      <div className="absolute top-20 right-0 w-48 h-48 sm:w-72 sm:h-72 md:w-96 md:h-96 bg-primary/10 rounded-full blur-3xl hidden md:block" />
      <div className="absolute bottom-20 left-0 w-48 h-48 sm:w-72 sm:h-72 md:w-96 md:h-96 bg-accent/10 rounded-full blur-3xl hidden md:block" />
            ...
            <div className="w-full">
              <Card className="p-4 md:p-6 sm:p-8 md:p-10 bg-card/97 backdrop-blur-xl border-2 border-border/70 shadow-premium hover:shadow-premium-lg hover:border-primary/40 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]">
                <div className="flex items-center gap-2 md:gap-3 sm:gap-4 mb-3 md:mb-4 sm:mb-6">
                  ...
                  <h3 className="text-lg md:text-xl sm:text-2xl font-bold text-foreground dark:text-card-foreground">
